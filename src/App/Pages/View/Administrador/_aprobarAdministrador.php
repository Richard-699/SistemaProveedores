...
<head>
    ...
    <title>Aprobar Administrador</title>
</head>
<body>
    ...
    <div class="px-3 py-2" style="width: 600px; max-width: 100%;">
        <div class="border-0 pb-3 mb-3 border-bottom d-flex justify-content-between align-items-center">
            <h5 class="m-0 fw-semibold">
                <i class="fa-solid fa-check me-2"></i>Aprobar Administrador
            </h5>
            <button data-fancybox-close class="btn-close" type="button" aria-label="Close"></button>
        </div>
        
        <form id="formAprobarAdministrador">
            <input type="hidden" id="admin_id_gestionar" name="id_administrador">
            <input type="hidden" id="admin_action_type" name="action" value="aprobarAdministrador">
            
            <div class="mb-5 mt-2 pb-2">
                <label for="selectPermisos" class="form-label mb-3">Seleccione los permisos que tendrá este administrador: <span class="text-danger">*</span></label>
        ...
        <div class="border-0 pt-3 mt-4 text-end">
            ...
            <button type="submit" class="btn btn-custom-teal" id="btnAprobarAdministrador">Aprobar Administrador</button>
        </div>
        </form>
    </div>
</div>
