...
<body>
    ...
    <div class="registro-container">
        ...
        <form id="form_proveedor" action="../../Handler/Auth/registroHandler.php" method="POST" class="registro-form" autocomplete="off" novalidate>
            ...
            <div class="form-group pt-3">
                ...
                <div class="input-wrapper">
                    ...
                    <button type="button" id="passwordToggle" onclick="togglePassword('inputPassword')" class="password-toggle hidden">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" width="24" height="24" style="transition: color 0.2s;">
