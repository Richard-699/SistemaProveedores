...
def migrate():
    ...
    insert_query = """
        ...
        (id_vinculacion_proveedor, estado_cumplimiento_vinculacion, observaciones_cumplimiento_vinculacion,
         estado_ambiental_vinculacion, observaciones_ambiental_vinculacion,
         estado_negociacion_vinculacion, observaciones_negociacion_vinculacion,
