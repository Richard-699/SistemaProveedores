...
<section>
    <div class="card card-principal">
        <div class="card-header">
            <?php echo $lang['title_representante_legal'] ?>
        </div>
        <div class="card-body">
            <form id="formRepresentanteLegal">
                <div class="row">
...
<button id="next_representanteLegal" class="btn btn-Laft-next"><?php echo $lang['siguiente'] ?></button>
<button id="back_representanteLegal" class="btn btn-Laft-back"><?php echo $lang['anterior'] ?></button>
