...
<section>
    ...
    <div class="card card-secondary">
        ...
        <div class="card-body" id="cardBody">
            <form id="formBeneficiariosFinales"enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-12">
                        <p><?php echo $lang['RUB'] ?></p>
                        <p style="color: red;"><?php echo $lang['Nota_RUB'] ?></p>
                    </div>
                    <div class="col-md-12" id="file_carta_beneficiarios_finales">
                        <input type="file" class="form-control file-input mt-2" name="carta_beneficiarios_finales" id="carta_beneficiarios_finales" accept=".pdf" required>
                    ...
                    <div class="col-md-12" style="display: none;" id="filePreviewContainercarta_beneficiarios_finales">
                        <div id="filePreviewContentcarta_beneficiarios_finales" class="mt-2"></div>
...
<button id="next_beneficiariosFinales" class="btn btn-Laft-next"><?php echo $lang['siguiente'] ?></button>
<button id="back_beneficiariosFinales" class="btn btn-Laft-back"><?php echo $lang['anterior'] ?></button>
